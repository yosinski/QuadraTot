...
optimizing a quadrupedal gait for linear speed, tested on a physical robot. \edit{Next sentence mistakenly copied?} We implemented and
...
and refine the simulator. \cite{glette2012evolution-of-locomotion-in-a-simulated} \edit{what is this citation for?}
...
complexities of HyperNEAT, a simpler algorithm on the code level \edit{???}
...
learning problems.\edit{probably rewrite this last paragraph}
