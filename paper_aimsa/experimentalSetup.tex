...
at the center. To avoid the formerly reported \edit{???} AX-18+ servos are used
...
robot. \edit{Explain this next part on smart cropping better.} Thus, RL PoWER were tested after carefully cropping out the
...
\figp{smartCrop}{1}{The red line is the cropping border, $g = j1 +  j2$. As shown in \figref{sixLegPositions} \edit{???}}
...
\figp{sixLegPositions}{1}{The left two positions are allowed; middle
  ...
  disallowed.   \\\editbox{Smart crop needs to be explained somewhere, probably briefly in this caption and more extensively in the text.}}
