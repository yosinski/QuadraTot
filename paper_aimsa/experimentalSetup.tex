...
the two dimensional space of j1 and j2. \figref{smartCrop}....

\figp{smartCrop}{1}{$g = j1 +  j2$ caption}

\figp{sixLegPositions}{1}{caption... the left two are allowed, middle
  two are on the red border line from \figref{smartCrop}, right two
  are disallowed.}
