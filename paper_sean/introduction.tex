...
\textbf{Right: } The robot in the simulator. Figure adapted from from Glette et al. 2012~\cite{glette}.}  
...
Yosinski et al. evolved gaits with HyperNEAT directly in hardware on the QuadraTot robot platform~(\figref{quadratotWhiteBooties}). They found that HyperNEAT's gaits outperformed manually designed, parameterized learning algorithms, but still did not produce impressive, natural gaits~\cite{yos:clune}. 
