...
\textbf{Right: } The representation of the robot in the simulator.}  
...
Yosinski et al. evolved gaits with HyperNEAT directly in hardware on the QuadraTot robot platform~(\figref{quadratotWhiteBooties}). They found that HyperNEAT's gaits outperformed manually designed, parameterized learning algorithms, but still did not produce impressive, natural gaits~\cite{yos:clune}.\footnote{Videos available at (Link removed for double-blind review)}
