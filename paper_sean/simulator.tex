...
In an attempt to more accurately model the robot behavior, we implemented the same cropping function in the simulator as in the actual robot. %JMC/SL - Do all results in this paper reflect this? / They will soon.
