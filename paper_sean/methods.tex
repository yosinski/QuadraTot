...
Each gait was evaluated for 12 seconds \edit{JBY: how? As in fig 4 of \cite{yos:clune}, or another way?}, both in simulation and in reality. 
All HyperNEAT parameters were identical to those in Yosinski et al. 2011~\cite{yos:clune} except for the frequency of the sine wave input to the ANN, which was lowered from 0.0265Hz to 0.004Hz to decrease the number of servo shutdowns due to high-frequency gaits \edit{JBY: what? why?}. 
...
If the average frequency of each leg \edit{JBY: any leg or all legs?} for the gait was higher than a threshold frequency (1.67 Hz), the fitness was punished by exponentially reducing the distance travelled by the robot:
