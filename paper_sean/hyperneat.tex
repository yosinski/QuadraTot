...
These functions allow evolution to exploit various properties that allow HyperNEAT to find regularities without further human intervention \cite{stanley1,clune1}. %such as symmetry (e.g. Gaussian) and repetition (e.g. sine function) \cite{stanley1}. 
