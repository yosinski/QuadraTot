...
\category{J.4.2 \edit{fix this}}{Jason isn't sure what this is}{The Dewey}[Decimal system for papers?]
\edit{JMC: See hidden comment}

%ACM requires this bizarre classification. You can copy mine from the quad paper...or if you care, find a gecco/acm paper where they evolve gaits in physical robots and copy theirs.
...
\keywords{\edit{fix this} Learning Control, Walking Robots, Gait Learning, Quadruped}
