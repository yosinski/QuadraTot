...
The results for the parameterized 
...
similar to or worse than gaits randomly-generated with the SineModel5
model (\figref{std_error}). None of these strategies consistently
outperformed the other maximizing strategies in the three trials; A
different strategy generated the best gait in each trial. Uniform
random hill climbing produced the best gait (11.37 body
...
\acmFigDouble{std_error}{.6}{Average results ($\pm $ SEM) for each of the parameterized learning methods.  Linear regression performed the best,
