...
We can write gaits without feedback --- also called feed forward gaits
--- as
...
\noindent for some measurement vector $\vec{z}$.  Though perhaps obvious, it
is worth noting that feedforward gaits are deterministic (unless they
...
measurements may result in different $\vec{x}$ values each time they are
run.
