...
\edit{make figure to go here (or another section), show drawing with
  inner/outer, l/r, and f/b motors.}

The nine subscripted functions correspond to the nine labeled motors
in \figref{robotDiagram}
...
\secref{fitnessEvaluation}, we decided to evaluate the different
...
\edit{following paragraph is figure caption for file named:
  hyperneatExplanation.png} HyperNEAT Produces ANNs from CPPNs. ANN
...
\edit{are we mentioning that we gave HyperNEAT the center joint here or earlier?}
\edit{jason: edit this section to reflect the post-processing...}

\edit{add the following paragraph as a figure caption to SpiderANN.jpg}
