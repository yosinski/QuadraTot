...
\vec{g}(t) =
\left[ {\begin{array}{cc} 
a \cdot \sin(\frac{2\pi t}{\tau}) \cdot m_F \cdot m_O & + offset \\ % 0
a \cdot \sin(\frac{2\pi t}{\tau}) \cdot m_F           & + offset \\ % 1
a \cdot \sin(\frac{2\pi t}{\tau})                     & + offset \\ % 2
a \cdot \sin(\frac{2\pi t}{\tau}) \cdot m_O           & + offset \\ % 3
a \cdot \sin(\frac{2\pi t}{\tau}) \cdot m_R           & + offset \\ % 4
a \cdot \sin(\frac{2\pi t}{\tau}) \cdot m_R \cdot m_O & + offset \\ % 5
a \cdot \sin(\frac{2\pi t}{\tau}) \cdot m_F \cdot m_R & + offset \\ % 6
a \cdot \sin(\frac{2\pi t}{\tau}) \cdot m_F \cdot m_R & + offset \\ % 7
0                                                     & + offset \\ % 8
\end{array} } \right]
\]
