...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    % depicted above.
    The robot is actuated by 9 AX-12+ Dynamixel servos: 8 for the legs and one at the center ``hip'' joint.
...
The fitness was the Euclidian distance the robot moved during a
12-second run on flat terrain.  To encourage gaits that did not tax
the motors, we penalized gaits that caused the servos to stop
...
to ensure fair fitness measurements. As
shown above the instantaneous robot limb configuration during the
first and last portions of the evaluation was an interpolation between
the initial ready position and $g(t)$.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    that encodes an ANN \pwfig{SpiderANN.jpg}{.7}{The ANN
      configuration used to generate gaits
    ...
    \pfig{neat_110115_211410_00000_002_filt_zoom}{1}{Joint angles for
...
gradient, 172 simplex, 153 linear regression). The SVM-modeled method
...
\pfig{hnResults}{.8}{Average fitness ($\pm $ SE) of the highest
