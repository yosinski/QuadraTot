...
interfaced with the Wii remote via bluetooth using the \code{CWiid}
library \citep{cwiid}.  Our fitness testing code communicated with this
...
remote whenever it wandered outside this window.  Initially this was a rare
