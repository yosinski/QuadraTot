...
The most computationally expensive portion of code was HyperNEAT, which took
less than one second to run (not including physical evaluation). Thus,
...
Robot gaits are defined by a Python \emph{gait function} that takes
