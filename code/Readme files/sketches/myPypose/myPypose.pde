...
void loop(){
    ...
    // update joints
	//should be called at around 30 Hz
    bioloid.interpolateStep(); //TODO: investigate quick fix by moving this line up into the while loop?
}
