...
\edit{flesh this out... more details}
...
\edit{also describe parameterized motion model}
...
\item \code{RunManager} class \edit{write this}
...
\item \code{MotionModel} abstract base class: Several functions exist,
  but none are within a class framework. ... ??? ... \code{SineModel}
...
\editbox{mention using speed as evaluating factor, ``we started the
...
We stop each run after plateauing results (no improvement 
