...
% A few sentences summarizing each of the items below
...
\subsection*{\code{Strategy} and \code{RunManager} class}
...
\subsection*{\code{WiiTrackClient} and \code{WiiTrackServer} classes
 and hardware}
...
\item \code{WiiTrackServer.py, WiiTrackClient.py}: ? Jason, write this.
\end{itemize}
