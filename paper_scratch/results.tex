...
\hline                                    
\hline                                    
Hand-coded gait                 & 5.16      \\
\hline
Policy Gradient Descent                  & 6.32      \\
\hline
Uniform Random Hill Climbing             & 7.83      \\
\hline
Random search                            & 9.40      \\
\hline
Gaussian Random Hill Climbing            & 10.03     \\
\hline
Nelder-Mead simplex                      & 12.32     \\
\hline
Linear Regression                        & 14.01     \\
\hline
HyperNEAT                                & 29.26     \\
\hline
\end{tabular}
...
times and found that its mean performance was 26 body lengths/minute
($\pm$ 13 SD), but it had a max of 38 and a min of 3.  Many
